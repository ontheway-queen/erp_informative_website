...
export const metadata: Metadata = {
  title: {
    default: "ERP Compass | Smart ERP Software Guide",
    template: "%s | ERP Compass",
  },
  description:
  ...
  authors: [{ name: "ERP Compass" }],
  creator: "ERP Compass",
  publisher: "ERP Compass",
  applicationName: "ERP Compass",
